...
\section{Oscilações em Energia}
	...
	\input{3_02_ComprimentoOrbCompactacaoMomento}
...
\section[Amortecimento por Radiação]{Amortecimento por Radiação\footnote{Neste capítulo, assume-se que a teoria clássica sobre radiaçao eletromagnética por elétrons relativísticos já é conhecida. Desta forma, apenas uma revisão é feita, pontuando os resultados necessários para este estudo.}}\label{part4}
	...
	\input{4_03_AmortecimentoBetatron}
	\input{4_04_TaxasAmortecimento}
	\pagebreak

\section{Excitação por Radiação}
	\input{5_01_RadiacaoQuantica}
	\input{5_02_FlutuacoesEnergia}
	\input{5_03_DistribuicaoFlutuacoes}
	\input{5_04_ComprimentoBunch}
	\input{5_05_LarguraFeixe}
	\input{5_06_AlturaFeixe}
	\input{5_07_TempoVidaOscilacoesRadiais}
	\input{5_08_TempoVidaOscilacoesEnergia}
	\pagebreak
